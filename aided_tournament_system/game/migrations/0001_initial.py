            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="time start"
                    ),
                ),
                (
                    "end_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="time end"
                    ),
                ),
                (
                    "round_game",
                    models.CharField(
                        choices=[
                            ...
                            ("III", "Third round"),
                            ("IV", "Fourth round"),
                            ("25", "Loser 25 place game"),
                            ("17", "Loser 17 place game"),
                            ("13", "Loser 13 place game"),
                            ("9", "Loser 9 place game"),
                            ("7", "Loser 7 place game"),
                            ("5", "Loser 5 place game"),
                            ("SF", "Semi-final game"),
                            ("3/4", "Game 3/4 places"),
                            ("F", "Final game"),
                        ],
                ...
                (
                    "court_number",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="court number"
                    ),
                ),
                (
                    "home_team_score",
