...
urlpatterns = [
    ...
    url(
        regex=r"^facebook/login/$", view=views.FacebookLogin.as_view(), name="fb_Login"
    ),
    url(regex=r"^google/login/$", view=views.GoogleLogin.as_view(), name="g_Login"),
    url(
        regex=r"^instagram/login/$",
